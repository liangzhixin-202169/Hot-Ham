...
class SelfInteraction(torch.nn.Module):
    def __init__(self,
        ...
        self.self_connection = o3.FullyConnectedTensorProduct(self.irreps_in,
                                                              o3.Irreps(f"{num_type}x0e"),
                                                              self.irreps_out)
    ...
    def forward(self, f_node, f_edge=None, node_emb=None, length_emb=None, data=None):
        ...
        self_connection = self.self_connection(f_node, node_emb)
        ...
        f_node = self_connection+f_node
        f_node = self.layernorm(f_node)
